function displayMessage() {
	$(document.body).append("<div id='black-background' style='background:rgba(0, 0, 0, 0.6); position: absolute; top:0; left:0; width: 100%; height: 100%;'></div>");
	$(document.body).append("<div id='net-message' style='text-align:center; padding:20px; width:80%; background:#eee; position:fixed; left:10%; top:25%; border-radius:5px; border:5px solid black;'></div>")
	$("#net-message").append("<h1 style='margin-top:5px;'>This is the internet <strong>without</strong> Net Neutrailty!</h1>");
	...
	$("#net-message").append("<p>Can you imagine if you wanted to switch from Comcast to one of there competitors, but you were unable to look into alternatives from your home network? This is a real possibility if Net Neutrality didn't exist because Comcast would have control over what you can browse on the internet.</p>");
	...
	$("#net-message").append("</ul>");
	$("#net-message").append("<p><h4>In mid-August there will be a vote to remove Net Neutrality and we need you to join our efforts to proect it!</h4></p>");
	$("#net-message").append("<h1><a style='text-decoration: none;' href='https://dearfcc.org/' target='_blank'>Tell the FCC you support Net Neutrailty!</a></h1>");
	//$("#net-message").append("<h1><a style='text-decoration: none;' href='http://www.house.gov/representatives/find/' target='_blank'>Tell your representative you support Net Neutrailty!</a></h1>");

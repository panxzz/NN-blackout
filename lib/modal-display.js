function displayMessage() { 
	...
	$('#NetMessage').append('<p style="text-align:center; color:#e5eefc;">Internet Service Providers may soon be able to slow or block content that they dont like, including content from their competitors. Tell the <a href="https://www.fcc.gov/about/contact" target="_blank" style="color:white">FCC</a> you support Net Neutrailty!</p>')
